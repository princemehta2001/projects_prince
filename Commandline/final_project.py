...
def sentiment(filename):
  with open(filename, 'r') as f1:
   ...
   for ftokenized in fsentece:
    ...
    with open("C:\\Users\\Lenovo\\projects\\Commandline\\positive.txt", 'r') as pos:
       pos_read = pos.read()
       ...
       for j in i:
                if (j in pos_read):
                   # print(j,'\tpos')
                    ppos += 1
        #print(ppos)
    with open('C:\\Users\\Lenovo\\projects\\Commandline\\negative.txt','r') as neg:
     neg_read=neg.read()
...
if (inp == '1'):
    with open("C:\\Users\\Lenovo\\projects\\Commandline\\file1.txt",'a') as inp:
...
call("C:\\Users\\Lenovo\\projects\\Commandline\\file1.txt")
print("\nNormal Method\n")
sentiment('C:\\Users\\Lenovo\\projects\\Commandline\\file1.txt')
